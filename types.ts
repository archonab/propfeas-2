...
// --- LINE ITEM SUMMARY (For P&L) ---
export interface LineItemSummary {
  id: string;
  category: CostCategory;
  description: string;
  netAmount: number; // Ex GST, includes escalation
  gstAmount: number; // Recoverable GST
  grossAmount: number; // Invoice Amount
  isImplicit: boolean; // Generated by system (e.g. Stamp Duty) vs User Input
}
...
export interface ReportModel {
  ...
  itemSummaries: LineItemSummary[]; // Detailed P&L Rows
  reconciliation: {
